...
【修正例4: 項番号が文章の途中に混入している場合】
修正前:
```
6. 会社は相談を受けた時は、速やかに事実関係の調査に着手し、セクハラに当たる行為か否
7.
かを慎重に判断し、申立者である社員が申立後も性的被害を受けないように対処する。
7. セクハラとは相手方の意に反する性的言動をいう。
```

修正後:
```
6. 会社は相談を受けた時は、速やかに事実関係の調査に着手し、セクハラに当たる行為か否かを慎重に判断し、申立者である社員が申立後も性的被害を受けないように対処する。
7. セクハラとは相手方の意に反する性的言動をいう。
```

【修正例5: 項番号がなく別の段落として認識されている場合】
修正前:
```
3. 会社の許可を得た場合は、休日や休暇中にアルバイトや副業などすることを認める場合がある。また、勤務時間外においても会社の許可を得た場合は認める。ただし、認める内容に関しては事前の申請内容をもとに慎重に判断して決定するものとする。
休日や休暇中のアルバイトや副業に関しての許可については、自己啓発につながるものやリフレッシュにつながること、人間性を高める仕事を会社は重視して判断するものとする。
4.
```
...
```
3. 会社の許可を得た場合は、休日や休暇中にアルバイトや副業などすることを認める場合がある。また、勤務時間外においても会社の許可を得た場合は認める。ただし、認める内容に関しては事前の申請内容をもとに慎重に判断して決定するものとする。
4. 休日や休暇中のアルバイトや副業に関しての許可については、自己啓発につながるものやリフレッシュにつながること、人間性を高める仕事を会社は重視して判断するものとする。
```
